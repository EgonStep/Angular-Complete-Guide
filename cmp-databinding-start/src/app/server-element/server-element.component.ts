...
export class ServerElementComponent implements OnInit, OnChanges, DoCheck,
  ...
  @ContentChild('contentParagraph') paragraphh: ElementRef;

  constructor() {
    console.log('Constructor called!');
  }

  // Only hook that receives elements
  ...
  ngOnInit(): void {
    ...
    console.log('text Content of paragraph: ' + this.paragraphh.nativeElement.textContent);
  }
